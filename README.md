...
| :--- | :--- | :--- | :--- |
| **Heuristic Logic** | Rule-based symbolic fallback | 0.154 ms | ~3.44 ms |
| **Pure Mathematics** | Direct tensor math execution | N/A | ~1.58 ms |
| **Latent Math (O(1))** | Dynamic DoRA Algebraic routing | **0.0002 ms** | **~1.66 ms** |
