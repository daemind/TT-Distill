...
void ggml_metal_set_tensor_async(ggml_metal_t         ctx,
...
void ggml_metal_get_tensor_async(ggml_metal_t               ctx,
                                 ...
                                 size_t                     offset,
                                 size_t                     size);
bool ggml_metal_cpy_tensor_async(ggml_metal_t               ctx_src,
                                 ggml_metal_t               ctx_dst,
...
GGML_API void ggml_metal_preload_dora(ggml_metal_t ctx, void * data, size_t size);
GGML_API void ggml_metal_swap_dora(ggml_metal_t ctx);
