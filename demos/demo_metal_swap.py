...
def run_demo() -> None:
    ...
    console.print("   Running 10,000 iterations of ggml_backend_metal_swap_dora(NULL)...")
    ...
    if not gater.metal_available:
        console.print("[yellow]⚠ Metal not available — skipping Phase 4[/yellow]")
    else:
